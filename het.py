...
file_loc = ['D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-apr14.csv',
            'D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-aug14.csv',
            'D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-jul14.csv',
            'D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-jun14.csv',
            'D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-may14.csv',
            'D://task_data//uber-tlc-foil-response//uber-trip-data//uber-raw-data-sep14.csv']

dfs = [dd.read_csv(file) for file in file_loc]
#print(dfs)
# date:string  Lat:float64	Lon:float64	Base_code:string

l15 = dd.read_csv(r'D:\task_data\uber-tlc-foil-response\uber-trip-data\uber-raw-data-janjune-15.csv\uber-raw-data-janjune-15.csv')
l1 = dd.read_csv(r"D:\task_data\uber-tlc-foil-response\uber-trip-data\taxi-zone-lookup.csv")
